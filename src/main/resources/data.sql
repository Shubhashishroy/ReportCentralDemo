...
insert into reportInfo values('EQSWAP50MMX','Interest Schedule Report','SWAP','TXT',CURRENT_TIMESTAMP());
insert into reportInfo values('MAC182XLS','Multi Asset Class Report','MAC','XLS',CURRENT_TIMESTAMP());